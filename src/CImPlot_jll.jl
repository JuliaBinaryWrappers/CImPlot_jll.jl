...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CImPlot_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("278f1f02-c5a0-563f-9174-e8b244dda450"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CImPlot", artifacts_toml) for e in artifacts["CImPlot"]]
...
if best_platform === nothing
    @debug("Unable to load CImPlot; unsupported platform $(triplet(platform_key_abi()))")
else
